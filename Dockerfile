...
RUN mkdir -p /run/lock ; yum install -y freeipa-client realmd /etc/selinux/targeted/contexts/dbus_contexts oddjob oddjob-mkhomedir sssd sssd-dbus adcli perl perl-Time-HiRes tar findutils && yum clean all
